...
namespace WisePharm.Finance
{
    ...
    ///</summarly>
    public abstract class AnimateBasePropety<Parent> : BaseAttachedProperty<Parent, bool>
    ...
    /// </summary>
    public class AnimateSlideInFromLeftProperty : AnimateBasePropety<AnimateSlideInFromLeftProperty>
    {
    ...
    /// </summary>
    public class AnimateSlideInFromRightProperty : AnimateBasePropety<AnimateSlideInFromRightProperty>
    {
        protected override async void DoAnimation(FrameworkElement element, bool value, bool firstLoad)
        {
            if (value)
